...
@import WebRTC;
#import "Lib/ARDAppClient.h"



@interface ARTCVideoChatViewController : UIViewController <ARDAppClientDelegate, RTCEAGLVideoViewDelegate>

@property (weak, nonatomic) IBOutlet NSLayoutConstraint *aspectRemoveView;
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *testHight;
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *testWight;

@property (assign, nonatomic) CGRect defoultRemoveFrame;
...
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *localViewTopConstraint;
...
@property (assign, nonatomic) CGAffineTransform defoultTransformLocalView;

@property (assign, nonatomic) CGAffineTransform defoultTransformRemoveView;
...
@property (assign, nonatomic) BOOL flagRotate;

@property (assign, nonatomic) UIDeviceOrientation oldOrientation;

@property (assign, nonatomic) BOOL leftRight;
